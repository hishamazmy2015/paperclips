...
export APP_NAME APP_ENV APP_DEBUG APP_KEY PLATFORM_BASE_DOMAIN DB_CONNECTION DB_HOST DB_PORT DB_DATABASE DB_USERNAME DB_PASSWORD \
  CACHE_STORE QUEUE_CONNECTION SESSION_DRIVER MEDIA_ROOT MAIL_MAILER WHATSAPP_PROVIDER CONTENT_GENERATOR OTP_SENDS_PER_IP OTP_VERIFIES_PER_IP LOG_CHANNEL LOG_LEVEL PHP_CLI_SERVER_WORKERS E2E_PORT
